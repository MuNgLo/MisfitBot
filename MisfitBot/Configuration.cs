...
using System.Data;
/*using MisfitBot_MKII.Plugins.Couch;
using MisfitBot_MKII.Plugins.MyPick;
using MisfitBot_MKII.Plugins.Admin;
using MisfitBot_MKII.Plugins.Betting;
using MisfitBot_MKII.Plugins.DeathCounter;
using MisfitBot_MKII.Plugins.PoorLifeChoices;
using MisfitBot_MKII.Plugins.Greeter;
using MisfitBot_MKII.Plugins.PluginTemplate;
using MisfitBot_MKII.Plugins.Raffle;
using MisfitBot_MKII.Plugins.Voting;
using MisfitBot_MKII.Plugins.MatchMaking;
using MisfitBot_MKII.Plugins.Queue;
*/
